    ...
    element: [
      {
        ...
        constraint: [
          ...
          },
          {
            ...
            expression:
              "lowNumerator.empty() or highNumerator.empty() or (lowNumerator <= highNumerator)",
            xpath:
              "not(exists(f:lowNumerator/f:value/@value)) or not(exists(f:highNumerator/f:value/@value)) or (number(f:lowNumerator/f:value/@value) <= number(f:highNumerator/f:value/@value))",
            source: "http://hl7.org/fhir/StructureDefinition/RatioRange",
          },
        ],
        isModifier: false,
