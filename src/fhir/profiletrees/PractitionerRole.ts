const data = [
  ...
  },
  {
    ...
    baseId: "PractitionerRole.implicitRules",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    ...
    baseId: "PractitionerRole.language",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  ...
  },
  {
    ...
    baseId: "PractitionerRole.contained",
    isPrimitive: false,
    childPaths: [],
    value: "",
  },
  {
    ...
    baseId: "PractitionerRole.modifierExtension",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "PractitionerRole.identifier", min: 0, max: "*" },
    ...
    baseId: "PractitionerRole.identifier",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "PractitionerRole.active", min: 0, max: "1" },
      type: [{ code: "boolean" }],
      meaningWhenMissing:
    ...
    baseId: "PractitionerRole.active",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "PractitionerRole.period", min: 0, max: "1" },
      type: [{ code: "Period" }],
      constraint: [
        {
          key: "ele-1",
      ...
      mapping: [
        ...
        { identity: "v2", map: "PRD-8/9 / PRA-5.4" },
        {
          identity: "rim",
    ...
    baseId: "PractitionerRole.period",
    isPrimitive: false,
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "PractitionerRole.practitioner", min: 0, max: "1" },
      type: [
        {
          code: "Reference",
          targetProfile: [
    ...
    dataPath: "root.practitioner",
    parentDataPath: "root",
    basePath: "root.practitioner",
    baseId: "PractitionerRole.practitioner",
    isPrimitive: false,
    childPaths: [
      "root.practitioner.reference",
      "root.practitioner.type",
      "root.practitioner.display",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.practitioner.reference",
    parentDataPath: "root.practitioner",
    basePath: "root.practitioner.reference",
    baseId: "Reference.reference",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.practitioner.type",
    parentDataPath: "root.practitioner",
    basePath: "root.practitioner.type",
    baseId: "Reference.type",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.practitioner.display",
    parentDataPath: "root.practitioner",
    basePath: "root.practitioner.display",
    baseId: "Reference.display",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "PractitionerRole.organization", min: 0, max: "1" },
      type: [
        {
          code: "Reference",
          targetProfile: [
    ...
    baseId: "PractitionerRole.organization",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "PractitionerRole.code", min: 0, max: "*" },
      type: [{ code: "CodeableConcept" }],
      constraint: [
        {
          key: "ele-1",
    ...
    parentDataPath: "root",
    basePath: "root.code",
    baseId: "PractitionerRole.code",
    isPrimitive: false,
    childPaths: ["root.code[0].coding[0]", "root.code[0].text"],
    value: "",
  },
  {
    element: {
    ...
    dataPath: "root.code[0].coding[0]",
    parentDataPath: "root.code[0]",
    basePath: "root.code.coding",
    baseId: "CodeableConcept.coding",
    isPrimitive: false,
    childPaths: [
      "root.code[0].coding[0].system",
      "root.code[0].coding[0].version",
      "root.code[0].coding[0].code",
      "root.code[0].coding[0].display",
      "root.code[0].coding[0].userSelected",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.code[0].coding[0].system",
    parentDataPath: "root.code[0].coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.code[0].coding[0].version",
    parentDataPath: "root.code[0].coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.code[0].coding[0].code",
    parentDataPath: "root.code[0].coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.code[0].coding[0].display",
    parentDataPath: "root.code[0].coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.code[0].coding[0].userSelected",
    parentDataPath: "root.code[0].coding[0]",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "PractitionerRole.specialty", min: 0, max: "*" },
      type: [{ code: "CodeableConcept" }],
      constraint: [
        {
          key: "ele-1",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "PractitionerRole.location", min: 0, max: "*" },
      type: [
        {
          code: "Reference",
    ...
    baseId: "PractitionerRole.location",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "PractitionerRole.healthcareService", min: 0, max: "*" },
      type: [
        {
          code: "Reference",
          targetProfile: [
    ...
    baseId: "PractitionerRole.healthcareService",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "PractitionerRole.telecom", min: 0, max: "*" },
    ...
    baseId: "PractitionerRole.telecom",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "PractitionerRole.availableTime", min: 0, max: "*" },
    ...
    baseId: "PractitionerRole.availableTime",
    isPrimitive: false,
  ...
  },
  {
    ...
    basePath: "root.modifierExtension",
    baseId: "PractitionerRole.availableTime.modifierExtension",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    ...
    baseId: "PractitionerRole.availableTime.daysOfWeek",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "PractitionerRole.availableTime.allDay", min: 0, max: "1" },
      type: [{ code: "boolean" }],
      constraint: [
        {
          key: "ele-1",
    ...
    baseId: "PractitionerRole.availableTime.allDay",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    ...
    baseId: "PractitionerRole.availableTime.availableStartTime",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    ...
    baseId: "PractitionerRole.availableTime.availableEndTime",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "PractitionerRole.notAvailable", min: 0, max: "*" },
      type: [{ code: "BackboneElement" }],
      constraint: [
        {
          key: "ele-1",
    ...
    baseId: "PractitionerRole.notAvailable",
    isPrimitive: false,
  ...
  },
  {
    ...
    basePath: "root.modifierExtension",
    baseId: "PractitionerRole.notAvailable.modifierExtension",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    ...
    baseId: "PractitionerRole.notAvailable.description",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "PractitionerRole.notAvailable.during", min: 0, max: "1" },
      type: [{ code: "Period" }],
      constraint: [
        {
          key: "ele-1",
    ...
    baseId: "PractitionerRole.notAvailable.during",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    ...
    baseId: "PractitionerRole.availabilityExceptions",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      definition:
        "Technical endpoints providing access to services operated for the practitioner with this role.",
      requirements:
        "Organizations have multiple systems that provide various services and ,ay also be different for practitioners too.\r\rSo the endpoint satisfies the need to be able to define the technical connection details for how to connect to them, and for what purpose.",
      min: 0,
      max: "*",
      base: { path: "PractitionerRole.endpoint", min: 0, max: "*" },
      type: [
        {
          code: "Reference",
    ...
    baseId: "PractitionerRole.endpoint",
    isPrimitive: false,
    childPaths: [
