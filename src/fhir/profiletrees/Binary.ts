const data = [
  ...
  },
  {
    element: {
      ...
      min: 1,
      max: "1",
      base: { path: "Binary.contentType", min: 1, max: "1" },
      type: [{ code: "code" }],
      constraint: [
        {
          key: "ele-1",
      ...
      mapping: [{ identity: "rim", map: "ED.mediaType" }],
    },
    dataPath: "root.contentType",
    parentDataPath: "root",
    basePath: "root.contentType",
    baseId: "Binary.contentType",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "Binary.securityContext", min: 0, max: "1" },
      type: [
        {
          code: "Reference",
    ...
    dataPath: "root.securityContext",
    parentDataPath: "root",
    basePath: "root.securityContext",
    baseId: "Binary.securityContext",
    isPrimitive: false,
    childPaths: [
      "root.securityContext.reference",
      "root.securityContext.type",
      "root.securityContext.display",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.securityContext.reference",
    parentDataPath: "root.securityContext",
    basePath: "root.securityContext.reference",
  ...
  },
  {
    ...
    dataPath: "root.securityContext.type",
    parentDataPath: "root.securityContext",
    basePath: "root.securityContext.type",
  ...
  },
  {
    ...
    dataPath: "root.securityContext.display",
    parentDataPath: "root.securityContext",
    basePath: "root.securityContext.display",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "Binary.data", min: 0, max: "1" },
      ...
      isModifier: false,
      isSummary: false,
      mapping: [{ identity: "rim", map: "ED.data" }],
    },
    dataPath: "root.data",
    parentDataPath: "root",
    basePath: "root.data",
