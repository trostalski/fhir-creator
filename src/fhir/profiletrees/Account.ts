const data = [
  ...
  },
  {
    ...
    dataPath: "root.servicePeriod",
    parentDataPath: "root",
    basePath: "root.servicePeriod",
    baseId: "Account.servicePeriod",
    isPrimitive: false,
    childPaths: [],
    value: "",
  },
  {
    ...
    baseId: "Account.coverage",
    isPrimitive: false,
    childPaths: ["root.coverage.coverage", "root.coverage.priority"],
    value: "",
  },
  {
    element: {
      ...
      isModifier: false,
      isSummary: true,
      mapping: [{ identity: "rim", map: ".coverage.sequenceNumber" }],
    },
    dataPath: "root.coverage.priority",
    parentDataPath: "root.coverage[0]",
    basePath: "root.priority",
    baseId: "Account.coverage.priority",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  ...
  },
  {
    element: {
      ...
      isModifier: false,
      isSummary: false,
      mapping: [{ identity: "rim", map: ".holder.guarantorRole" }],
    },
    dataPath: "root.guarantor[0]",
    parentDataPath: "root",
    basePath: "root.guarantor",
    baseId: "Account.guarantor",
    isPrimitive: false,
    childPaths: [
      "root.guarantor.party",
      "root.guarantor.onHold",
      "root.guarantor.period",
    ],
    value: "",
  },
  {
    element: {
      ...
      isModifier: false,
      isSummary: false,
      mapping: [{ identity: "rim", map: ".holder.guarantorRole.statusCode" }],
    },
    dataPath: "root.guarantor.onHold",
    parentDataPath: "root.guarantor[0]",
    basePath: "root.onHold",
    baseId: "Account.guarantor.onHold",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
