const data = [
  ...
  },
  {
    element: {
      ...
      isModifier: true,
      isModifierReason:
        "This element is labeled as a modifier because the implicit rules may provide additional knowledge about the resource that modifies its meaning or interpretation",
      isSummary: true,
    },
  ...
  },
  {
    element: {
      ...
      min: 1,
      max: "1",
      base: { path: "Condition.clinicalStatus", min: 1, max: "1" },
      type: [{ code: "CodeableConcept" }],
      condition: ["con-3", "con-2"],
      constraint: [
        {
          key: "ele-1",
          severity: "error",
      ...
      binding: {
        ...
        valueSet:
          "http://hl7.org/fhir/ValueSet/condition-clinical|6.0.0-cibuild",
      },
      mapping: [
  ...
  },
  {
    element: {
      ...
      binding: {
        ...
        valueSet:
          "http://hl7.org/fhir/ValueSet/condition-ver-status|6.0.0-cibuild",
      },
      mapping: [
        { identity: "w5", map: "FiveWs.status" },
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "Condition.participant", min: 0, max: "*" },
      ...
      isModifier: false,
      isSummary: true,
      mapping: [{ identity: "rim", map: ".participation[typeCode=PRF]" }],
    },
    dataPath: "root.participant[0]",
    parentDataPath: "root",
    basePath: "root.participant",
    baseId: "Condition.participant",
    isPrimitive: false,
    childPaths: ["root.participant.function", "root.participant.actor"],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "Condition.participant.function", min: 0, max: "1" },
      type: [{ code: "CodeableConcept" }],
      constraint: [
        {
          key: "ele-1",
      ...
      binding: {
        extension: [
          {
            url: "http://hl7.org/fhir/StructureDefinition/elementdefinition-bindingName",
            valueString: "ConditionParticipantFunction",
          },
          {
            url: "http://hl7.org/fhir/StructureDefinition/elementdefinition-isCommonBinding",
            valueBoolean: true,
      ...
      mapping: [{ identity: "rim", map: ".participation.functionCode" }],
    },
    dataPath: "root.participant.function",
    parentDataPath: "root.participant[0]",
    basePath: "root.function",
    baseId: "Condition.participant.function",
    isPrimitive: false,
    childPaths: [
      "root.participant.function.coding[0]",
      "root.participant.function.text",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.participant.function.coding[0]",
    parentDataPath: "root.participant.function",
    basePath: "root.function.coding",
    baseId: "CodeableConcept.coding",
    isPrimitive: false,
    childPaths: [
      "root.participant.function.coding[0].system",
      "root.participant.function.coding[0].version",
      "root.participant.function.coding[0].code",
      "root.participant.function.coding[0].display",
      "root.participant.function.coding[0].userSelected",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.participant.function.coding[0].system",
    parentDataPath: "root.participant.function.coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.participant.function.coding[0].version",
    parentDataPath: "root.participant.function.coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.participant.function.coding[0].code",
    parentDataPath: "root.participant.function.coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.participant.function.coding[0].display",
    parentDataPath: "root.participant.function.coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.participant.function.coding[0].userSelected",
    parentDataPath: "root.participant.function.coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.participant.function.text",
    parentDataPath: "root.participant.function",
  ...
  },
  {
    element: {
      ...
      min: 1,
      max: "1",
      base: { path: "Condition.participant.actor", min: 1, max: "1" },
      type: [
        {
          code: "Reference",
          targetProfile: [
    ...
    parentDataPath: "root.participant[0]",
    basePath: "root.actor",
    baseId: "Condition.participant.actor",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    ...
    isPrimitive: false,
    childPaths: ["root.evidence[0].concept", "root.evidence[0].reference"],
    value: "",
  },
  {
    element: {
    ...
    dataPath: "root.evidence[0].concept",
    parentDataPath: "root.evidence[0]",
    basePath: "root.evidence.concept",
    baseId: "CodeableReference.concept",
    isPrimitive: false,
    childPaths: [
      "root.evidence[0].concept.coding[0]",
      "root.evidence[0].concept.text",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.evidence[0].concept.coding[0]",
    parentDataPath: "root.evidence[0].concept",
    basePath: "root.evidence.concept.coding",
    baseId: "CodeableConcept.coding",
    isPrimitive: false,
    childPaths: [
      "root.evidence[0].concept.coding[0].system",
      "root.evidence[0].concept.coding[0].version",
      "root.evidence[0].concept.coding[0].code",
      "root.evidence[0].concept.coding[0].display",
      "root.evidence[0].concept.coding[0].userSelected",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.evidence[0].concept.coding[0].system",
    parentDataPath: "root.evidence[0].concept.coding[0]",
    basePath: "root.evidence.concept.coding.system",
    baseId: "Coding.system",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.evidence[0].concept.coding[0].version",
    parentDataPath: "root.evidence[0].concept.coding[0]",
    basePath: "root.evidence.concept.coding.version",
    baseId: "Coding.version",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.evidence[0].concept.coding[0].code",
    parentDataPath: "root.evidence[0].concept.coding[0]",
    basePath: "root.evidence.concept.coding.code",
    baseId: "Coding.code",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.evidence[0].concept.coding[0].display",
    parentDataPath: "root.evidence[0].concept.coding[0]",
    basePath: "root.evidence.concept.coding.display",
    baseId: "Coding.display",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.evidence[0].concept.coding[0].userSelected",
    parentDataPath: "root.evidence[0].concept.coding[0]",
    basePath: "root.evidence.concept.coding.userSelected",
    baseId: "Coding.userSelected",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.evidence[0].concept.text",
    parentDataPath: "root.evidence[0].concept",
    basePath: "root.evidence.concept.text",
    baseId: "CodeableConcept.text",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.evidence[0].reference",
    parentDataPath: "root.evidence[0]",
    basePath: "root.evidence.reference",
    baseId: "CodeableReference.reference",
    isPrimitive: false,
    childPaths: [
      "root.evidence[0].reference.reference",
      "root.evidence[0].reference.type",
      "root.evidence[0].reference.display",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.evidence[0].reference.reference",
    parentDataPath: "root.evidence[0].reference",
    basePath: "root.evidence.reference.reference",
    baseId: "Reference.reference",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.evidence[0].reference.type",
    parentDataPath: "root.evidence[0].reference",
    basePath: "root.evidence.reference.type",
    baseId: "Reference.type",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.evidence[0].reference.display",
    parentDataPath: "root.evidence[0].reference",
    basePath: "root.evidence.reference.display",
    baseId: "Reference.display",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    element: {
      ...
      constraint: [
        {
          ...
          severity: "warning",
          human:
            "If category is problems list item, the clinicalStatus should not be unknown",
          expression:
      ...
      mapping: [
        {
          identity: "rim",
          map: "Entity, Role, or Act,Observation[classCode=OBS, moodCode=EVN, code=ASSERTION, value<Diagnosis]",
        },
