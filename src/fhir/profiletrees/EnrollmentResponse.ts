const data = [
  ...
  },
  {
    ...
    parentDataPath: "root",
    basePath: "root.text",
    baseId: "EnrollmentResponse.text",
    isPrimitive: false,
  ...
  },
  {
    ...
    baseId: "EnrollmentResponse.modifierExtension",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "EnrollmentResponse.identifier", min: 0, max: "*" },
      ...
      isModifier: false,
      isSummary: false,
      mapping: [{ identity: "workflow", map: "Event.identifier" }],
    },
    dataPath: "root.identifier[0]",
    parentDataPath: "root",
    basePath: "root.identifier",
    baseId: "EnrollmentResponse.identifier",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "EnrollmentResponse.request", min: 0, max: "1" },
      type: [
        {
          code: "Reference",
          targetProfile: [
    ...
    baseId: "EnrollmentResponse.request",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "EnrollmentResponse.organization", min: 0, max: "1" },
      type: [
        {
          code: "Reference",
          targetProfile: [
    ...
    baseId: "EnrollmentResponse.organization",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    ...
    isPrimitive: false,
    childPaths: [
      "root.requestProvider.reference",
      "root.requestProvider.type",
      "root.requestProvider.display",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.requestProvider.reference",
    parentDataPath: "root.requestProvider",
    basePath: "root.requestProvider.reference",
    baseId: "Reference.reference",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.requestProvider.type",
    parentDataPath: "root.requestProvider",
    basePath: "root.requestProvider.type",
    baseId: "Reference.type",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.requestProvider.display",
    parentDataPath: "root.requestProvider",
    basePath: "root.requestProvider.display",
    baseId: "Reference.display",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
