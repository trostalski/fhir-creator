const data = [
  ...
  },
  {
    ...
    baseId: "RelatedPerson.modifierExtension",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "RelatedPerson.identifier", min: 0, max: "*" },
    ...
    baseId: "RelatedPerson.identifier",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    element: {
      ...
      min: 1,
      max: "1",
      base: { path: "RelatedPerson.patient", min: 1, max: "1" },
      type: [
        {
          code: "Reference",
  ...
  },
  {
    ...
    isPrimitive: false,
    childPaths: ["root.relationship[0].coding[0]", "root.relationship[0].text"],
    value: "",
  },
  {
    element: {
    ...
    dataPath: "root.relationship[0].coding[0]",
    parentDataPath: "root.relationship[0]",
    basePath: "root.relationship.coding",
    baseId: "CodeableConcept.coding",
    isPrimitive: false,
    childPaths: [
      "root.relationship[0].coding[0].system",
      "root.relationship[0].coding[0].version",
      "root.relationship[0].coding[0].code",
      "root.relationship[0].coding[0].display",
      "root.relationship[0].coding[0].userSelected",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.relationship[0].coding[0].system",
    parentDataPath: "root.relationship[0].coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.relationship[0].coding[0].version",
    parentDataPath: "root.relationship[0].coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.relationship[0].coding[0].code",
    parentDataPath: "root.relationship[0].coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.relationship[0].coding[0].display",
    parentDataPath: "root.relationship[0].coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.relationship[0].coding[0].userSelected",
    parentDataPath: "root.relationship[0].coding[0]",
  ...
  },
  {
    ...
    dataPath: "root.relationship[0].text",
    parentDataPath: "root.relationship[0]",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "RelatedPerson.name", min: 0, max: "*" },
      type: [{ code: "HumanName" }],
      constraint: [
        {
          key: "ele-1",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "RelatedPerson.address", min: 0, max: "*" },
      type: [{ code: "Address" }],
      constraint: [
        {
          key: "ele-1",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "RelatedPerson.period", min: 0, max: "1" },
      type: [{ code: "Period" }],
      constraint: [
        {
          key: "ele-1",
  ...
  },
  {
    ...
    basePath: "root.modifierExtension",
    baseId: "RelatedPerson.communication.modifierExtension",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
