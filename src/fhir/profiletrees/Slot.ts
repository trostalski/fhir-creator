const data = [
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "Slot.identifier", min: 0, max: "*" },
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "Slot.serviceCategory", min: 0, max: "*" },
      type: [{ code: "CodeableConcept" }],
      constraint: [
        {
          key: "ele-1",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "Slot.serviceType", min: 0, max: "*" },
      type: [{ code: "CodeableConcept" }],
      constraint: [
        {
          key: "ele-1",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "Slot.specialty", min: 0, max: "*" },
      type: [{ code: "CodeableConcept" }],
      constraint: [
        {
          key: "ele-1",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "Slot.appointmentType", min: 0, max: "1" },
      type: [{ code: "CodeableConcept" }],
      constraint: [
        {
          key: "ele-1",
  ...
  },
  {
    element: {
      ...
      min: 1,
      max: "1",
      base: { path: "Slot.schedule", min: 1, max: "1" },
      type: [
        {
          code: "Reference",
    ...
    dataPath: "root.schedule",
    parentDataPath: "root",
    basePath: "root.schedule",
    baseId: "Slot.schedule",
    isPrimitive: false,
    childPaths: [
      "root.schedule.reference",
      "root.schedule.type",
      "root.schedule.display",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.schedule.reference",
    parentDataPath: "root.schedule",
    basePath: "root.schedule.reference",
    baseId: "Reference.reference",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.schedule.type",
    parentDataPath: "root.schedule",
    basePath: "root.schedule.type",
    baseId: "Reference.type",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.schedule.display",
    parentDataPath: "root.schedule",
    basePath: "root.schedule.display",
    baseId: "Reference.display",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    element: {
      ...
      min: 1,
      max: "1",
      base: { path: "Slot.status", min: 1, max: "1" },
      type: [{ code: "code" }],
      constraint: [
        {
          key: "ele-1",
  ...
  },
  {
    element: {
      ...
      min: 1,
      max: "1",
      base: { path: "Slot.start", min: 1, max: "1" },
      type: [{ code: "instant" }],
      constraint: [
        {
          key: "ele-1",
  ...
  },
  {
    element: {
      ...
      min: 1,
      max: "1",
      base: { path: "Slot.end", min: 1, max: "1" },
      type: [{ code: "instant" }],
      constraint: [
        {
          key: "ele-1",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "Slot.overbooked", min: 0, max: "1" },
      type: [{ code: "boolean" }],
      meaningWhenMissing:
    ...
    dataPath: "root.overbooked",
    parentDataPath: "root",
    basePath: "root.overbooked",
    baseId: "Slot.overbooked",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "Slot.comment", min: 0, max: "1" },
      type: [{ code: "string" }],
      constraint: [
        {
          key: "ele-1",
