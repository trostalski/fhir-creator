const data = [
  ...
  },
  {
    ...
    baseId: "DocumentManifest.implicitRules",
    isPrimitive: true,
  ...
  },
  {
    ...
    baseId: "DocumentManifest.language",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  ...
  },
  {
    ...
    baseId: "DocumentManifest.contained",
    isPrimitive: false,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "DocumentManifest.identifier", min: 0, max: "*" },
      ...
      mapping: [
        ...
        { identity: "v2", map: "TXA-16-Unique Document File Name?" },
        { identity: "rim", map: ".id / .setId" },
        { identity: "xds", map: "SubmissionSet.entryUUID" },
      ],
    },
    dataPath: "root.identifier[0]",
    parentDataPath: "root",
    basePath: "root.identifier",
    baseId: "DocumentManifest.identifier",
    isPrimitive: false,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 1,
      max: "1",
      base: { path: "DocumentManifest.status", min: 1, max: "1" },
      type: [{ code: "code" }],
      constraint: [
        {
          key: "ele-1",
      ...
      mapping: [
        ...
        { identity: "xds", map: "SubmissionSet status" },
      ],
    },
    dataPath: "root.status",
    parentDataPath: "root",
    basePath: "root.status",
    baseId: "DocumentManifest.status",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "DocumentManifest.type", min: 0, max: "1" },
      ...
      mapping: [
        ...
        { identity: "xds", map: "SubmissionSet.contentTypeCode" },
      ],
    },
    dataPath: "root.type",
    parentDataPath: "root",
    basePath: "root.type",
    baseId: "DocumentManifest.type",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "DocumentManifest.created", min: 0, max: "1" },
      type: [{ code: "dateTime" }],
      constraint: [
        {
          key: "ele-1",
      ...
      mapping: [
        ...
        { identity: "xds", map: "SubmissionSet.submissionTime" },
      ],
    },
    dataPath: "root.created",
    parentDataPath: "root",
    basePath: "root.created",
    baseId: "DocumentManifest.created",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "DocumentManifest.recipient", min: 0, max: "*" },
      type: [
        {
          code: "Reference",
          targetProfile: [
      ...
      mapping: [
        ...
        { identity: "rim", map: ".participation[typeCode=IRCP].role" },
        { identity: "xds", map: "SubmissionSet.intendedRecipient" },
      ],
    },
    dataPath: "root.recipient[0]",
    parentDataPath: "root",
    basePath: "root.recipient",
    baseId: "DocumentManifest.recipient",
    isPrimitive: false,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "DocumentManifest.source", min: 0, max: "1" },
      type: [{ code: "uri" }],
      constraint: [
        {
          key: "ele-1",
      ...
      isSummary: false,
      mapping: [
        { identity: "rim", map: ".participation[typeCode=PFM].time" },
        { identity: "xds", map: "SubmissionSet.sourceId" },
      ],
    },
    dataPath: "root.source",
    parentDataPath: "root",
    basePath: "root.source",
    baseId: "DocumentManifest.source",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "DocumentManifest.description", min: 0, max: "1" },
      type: [{ code: "string" }],
      constraint: [
        {
          key: "ele-1",
      ...
      mapping: [
        ...
        { identity: "xds", map: "SubmissionSet.title" },
      ],
    },
    dataPath: "root.description",
    parentDataPath: "root",
    basePath: "root.description",
    baseId: "DocumentManifest.description",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "DocumentManifest.related", min: 0, max: "*" },
    ...
    dataPath: "root.related[0]",
    parentDataPath: "root",
    basePath: "root.related",
    baseId: "DocumentManifest.related",
    isPrimitive: false,
    childPaths: ["root.related.identifier", "root.related.ref"],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "DocumentManifest.related.ref", min: 0, max: "1" },
      type: [
        {
          code: "Reference",
    ...
    dataPath: "root.related.ref",
    parentDataPath: "root.related[0]",
    basePath: "root.ref",
    baseId: "DocumentManifest.related.ref",
    isPrimitive: false,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "DocumentManifest", min: 0, max: "*" },
      constraint: [
        {
          key: "dom-2",
          severity: "error",
      ...
      mapping: [
        ...
        { identity: "rim", map: "Act[classCode=FOLDER, moodCode=EVN]" },
