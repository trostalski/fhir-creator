const data = [
  ...
  },
  {
    ...
    baseId: "DocumentManifest.modifierExtension",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "DocumentManifest.masterIdentifier", min: 0, max: "1" },
      ...
      mapping: [
        ...
        { identity: "xds", map: "SubmissionSet.uniqueId" },
      ],
    },
    dataPath: "root.masterIdentifier",
    parentDataPath: "root",
    basePath: "root.masterIdentifier",
    baseId: "DocumentManifest.masterIdentifier",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "DocumentManifest.subject", min: 0, max: "1" },
      type: [
        {
          code: "Reference",
          targetProfile: [
      ...
      mapping: [
        ...
        { identity: "xds", map: "SubmissionSet.patientId" },
    ...
    baseId: "DocumentManifest.subject",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    element: {
      ...
      min: 0,
      max: "*",
      base: { path: "DocumentManifest.author", min: 0, max: "*" },
      type: [
        {
          code: "Reference",
          targetProfile: [
      ...
      mapping: [
        ...
        { identity: "xds", map: "SubmissionSet.author" },
      ],
    },
    dataPath: "root.author[0]",
    parentDataPath: "root",
    basePath: "root.author",
    baseId: "DocumentManifest.author",
    isPrimitive: false,
    childPaths: [
  ...
  },
  {
    ...
    isPrimitive: false,
    childPaths: [
      "root.recipient[0].reference",
      "root.recipient[0].type",
      "root.recipient[0].display",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.recipient[0].reference",
    parentDataPath: "root.recipient[0]",
  ...
  },
  {
    ...
    dataPath: "root.recipient[0].type",
    parentDataPath: "root.recipient[0]",
  ...
  },
  {
    ...
    dataPath: "root.recipient[0].display",
    parentDataPath: "root.recipient[0]",
  ...
  },
  {
    element: {
      ...
      min: 1,
      max: "*",
      base: { path: "DocumentManifest.content", min: 1, max: "*" },
      type: [
        {
          code: "Reference",
      ...
      mapping: [
        ...
        { identity: "xds", map: "SubmissionSet DocumentEntry(s)" },
      ],
    },
    dataPath: "root.content[0]",
    parentDataPath: "root",
    basePath: "root.content",
    baseId: "DocumentManifest.content",
    isPrimitive: false,
    childPaths: [
      "root.content[0].reference",
      "root.content[0].type",
      "root.content[0].display",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.content[0].reference",
    parentDataPath: "root.content[0]",
    basePath: "root.content.reference",
    baseId: "Reference.reference",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.content[0].type",
    parentDataPath: "root.content[0]",
    basePath: "root.content.type",
    baseId: "Reference.type",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.content[0].display",
    parentDataPath: "root.content[0]",
    basePath: "root.content.display",
    baseId: "Reference.display",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    isPrimitive: false,
    childPaths: ["root.related[0].modifierExtension[0]"],
    value: "",
  },
  {
    element: {
    ...
    dataPath: "root.related[0].modifierExtension[0]",
    parentDataPath: "root.related[0]",
    basePath: "root.related.modifierExtension",
  ...
  },
  {
    ...
    dataPath: "root.related.modifierExtension[0]",
    parentDataPath: "root.related",
    basePath: "root.modifierExtension",
    baseId: "DocumentManifest.related.modifierExtension",
    isPrimitive: true,
    isRootPrimitive: true,
    childPaths: [],
    value: "",
  },
  {
    element: {
      ...
      min: 0,
      max: "1",
      base: { path: "DocumentManifest.related.identifier", min: 0, max: "1" },
      type: [{ code: "Identifier" }],
      constraint: [
        {
          key: "ele-1",
    ...
    dataPath: "root.related.identifier",
    parentDataPath: "root.related",
    basePath: "root.identifier",
    baseId: "DocumentManifest.related.identifier",
    isPrimitive: false,
    childPaths: [
      "root.related.identifier.use",
      "root.related.identifier.type",
      "root.related.identifier.system",
      "root.related.identifier.value",
      "root.related.identifier.period",
      "root.related.identifier.assigner",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.related.identifier.use",
    parentDataPath: "root.related.identifier",
    basePath: "root.identifier.use",
    baseId: "Identifier.use",
    isPrimitive: true,
    isRootPrimitive: false,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.type",
    parentDataPath: "root.related.identifier",
    basePath: "root.identifier.type",
    baseId: "Identifier.type",
    isPrimitive: false,
    childPaths: [
      "root.related.identifier.type.coding[0]",
      "root.related.identifier.type.text",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.related.identifier.type.coding[0]",
    parentDataPath: "root.related.identifier.type",
    basePath: "root.identifier.type.coding",
    baseId: "CodeableConcept.coding",
    isPrimitive: false,
    childPaths: [
      "root.related.identifier.type.coding[0].system",
      "root.related.identifier.type.coding[0].version",
      "root.related.identifier.type.coding[0].code",
      "root.related.identifier.type.coding[0].display",
      "root.related.identifier.type.coding[0].userSelected",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.related.identifier.type.coding[0].system",
    parentDataPath: "root.related.identifier.type.coding[0]",
    basePath: "root.identifier.type.coding.system",
    baseId: "Coding.system",
    isPrimitive: true,
    isRootPrimitive: false,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.type.coding[0].version",
    parentDataPath: "root.related.identifier.type.coding[0]",
    basePath: "root.identifier.type.coding.version",
    baseId: "Coding.version",
    isPrimitive: true,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.type.coding[0].code",
    parentDataPath: "root.related.identifier.type.coding[0]",
    basePath: "root.identifier.type.coding.code",
    baseId: "Coding.code",
    isPrimitive: true,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.type.coding[0].display",
    parentDataPath: "root.related.identifier.type.coding[0]",
    basePath: "root.identifier.type.coding.display",
    baseId: "Coding.display",
    isPrimitive: true,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.type.coding[0].userSelected",
    parentDataPath: "root.related.identifier.type.coding[0]",
    basePath: "root.identifier.type.coding.userSelected",
    baseId: "Coding.userSelected",
    isPrimitive: true,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.type.text",
    parentDataPath: "root.related.identifier.type",
    basePath: "root.identifier.type.text",
    baseId: "CodeableConcept.text",
    isPrimitive: true,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.system",
    parentDataPath: "root.related.identifier",
    basePath: "root.identifier.system",
    baseId: "Identifier.system",
    isPrimitive: true,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.value",
    parentDataPath: "root.related.identifier",
    basePath: "root.identifier.value",
    baseId: "Identifier.value",
    isPrimitive: true,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.period",
    parentDataPath: "root.related.identifier",
    basePath: "root.identifier.period",
    baseId: "Identifier.period",
    isPrimitive: false,
    childPaths: [
      "root.related.identifier.period.start",
      "root.related.identifier.period.end",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.related.identifier.period.start",
    parentDataPath: "root.related.identifier.period",
    basePath: "root.identifier.period.start",
    baseId: "Period.start",
    isPrimitive: true,
    isRootPrimitive: false,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.period.end",
    parentDataPath: "root.related.identifier.period",
    basePath: "root.identifier.period.end",
    baseId: "Period.end",
    isPrimitive: true,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.assigner",
    parentDataPath: "root.related.identifier",
    basePath: "root.identifier.assigner",
    baseId: "Identifier.assigner",
    isPrimitive: false,
    childPaths: [
      "root.related.identifier.assigner.reference",
      "root.related.identifier.assigner.type",
      "root.related.identifier.assigner.display",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.related.identifier.assigner.reference",
    parentDataPath: "root.related.identifier.assigner",
    basePath: "root.identifier.assigner.reference",
    baseId: "Reference.reference",
    isPrimitive: true,
    isRootPrimitive: false,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.assigner.type",
    parentDataPath: "root.related.identifier.assigner",
    basePath: "root.identifier.assigner.type",
    baseId: "Reference.type",
    isPrimitive: true,
  ...
  },
  {
    ...
    dataPath: "root.related.identifier.assigner.display",
    parentDataPath: "root.related.identifier.assigner",
    basePath: "root.identifier.assigner.display",
    baseId: "Reference.display",
    isPrimitive: true,
  ...
  },
  {
    ...
    isPrimitive: false,
    childPaths: [
      "root.related.ref.reference",
      "root.related.ref.type",
      "root.related.ref.display",
    ],
    value: "",
  },
  {
    ...
    dataPath: "root.related.ref.reference",
    parentDataPath: "root.related.ref",
    basePath: "root.ref.reference",
    baseId: "Reference.reference",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.related.ref.type",
    parentDataPath: "root.related.ref",
    basePath: "root.ref.type",
    baseId: "Reference.type",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
  ...
  },
  {
    ...
    dataPath: "root.related.ref.display",
    parentDataPath: "root.related.ref",
    basePath: "root.ref.display",
    baseId: "Reference.display",
    isPrimitive: true,
    isRootPrimitive: false,
    childPaths: [],
